...
class GreenSlipPage(BasePage):
    ...
    def _build_dispensation_tab(self) -> QWidget:
        ...
        year_course_widget = QWidget()
        year_course_widget.setStyleSheet("background: transparent;")
        ...
        _lbl_pr = lbl("Purpose / Reason", True)
        _lbl_pr.setContentsMargins(0, 8, 0, 0)
        form_lay.addWidget(_lbl_pr, 3, 0, Qt.AlignTop)
